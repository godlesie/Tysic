...
public class GraAddDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        mEditTextContract1 = mView.findViewById(R.id.edit_text_contract1);
        mEditTextContract2 = mView.findViewById(R.id.edit_text_contract2);
        mEditTextContract3 = mView.findViewById(R.id.edit_text_contract3);
